...
class ScentflowSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $baccarat = Product::create([
            ...
            'sku'               => 'PRD-BCC-RGE',
            'category'          => 'Unisex',
            'description'       => 'Aroma mewah perpaduan dari wangi melati, saffron, amberwood, dan cedarwood yang memberikan kesan elegan dan timeless.',
        ...
        $sauvage = Product::create([
            ...
            'sku'               => 'PRD-SVG-DIO',
            'category'          => 'Men',
            'description'       => 'Wangi maskulin yang segar dan radikal berkat perpaduan bergamot Calabria yang berair serta semburan amberwood yang pekat.',
            'base_price_per_ml' => 6000.00,
            'image'             => 'products/sauvage.png',
            'is_available'      => true,
        ]);

        // 4. DATA RESEP RACIKAN UTAMA (Diselaraskan dengan Kolom Bahasa Inggris di Migrasi)
        ...
        ProductRecipe::create([
            ...
            'fragrance_material_id' => $bibitBaccarat->id,
            'fragrance_volume'      => 15.00,
            'mixture_material_id'   => $absolut->id,
            'mixture_volume'        => 15.00,
            'bottle_material_id'    => $botol30->id,
        ...
        ProductRecipe::create([
            ...
            'fragrance_material_id' => $bibitBaccarat->id,
            'fragrance_volume'      => 20.00,
            'mixture_material_id'   => $absolut->id,
            'mixture_volume'        => 10.00,
            'bottle_material_id'    => $botol30->id,
